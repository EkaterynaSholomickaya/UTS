    ...
    <div className="container">
      ...
      <div className={styles.offers__table}>
        ...
        <div className={styles.offer}>
          ...
          <div className={styles.offer__text}>
            <span>Забота о сотрудниках:</span><br />  комфортный офис и все необходимое для эффективной работы. ДМС после 6 месяцев в компании.
          </div>
        </div>
        <div className={styles.offer}>
          <img className={styles.offer__img} src={fourth} alt="" />
          <div className={styles.offer__text}>
            <span> Открытость руководства компании. </span><br /> Возможность предлагать новые направления бизнеса, совершенствовать бизнес-модель и реализовывать новые проекты.
          </div>
        </div>
        <div className={styles.offer}>
        ...
        <div className={styles.offer}>
          ...
          <div className={styles.offer__text}>
            ...
            В рамках проекта «Школа ЕТС» мы оказываем сотрудникам поддержку в повышении квалификации, участие в профессиональных конференциях, изучении английского языка (курсы в офисе и Speaking Club).  И, конечно, возможности карьерного роста
          </div>
        </div>
        <div className={styles.offer}>
